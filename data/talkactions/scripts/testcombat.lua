...
function onSay(player, words, param)
	...
	condition:setParameter(CONDITION_PARAM_SPECIALSKILL_CRITICALHITCHANCE, 100) -- 100% chance para teste!
	...
	player:sendTextMessage(MESSAGE_STATUS_CONSOLE_BLUE, "- Critical Hit: 100% chance, +50% damage (TESTE!)")
